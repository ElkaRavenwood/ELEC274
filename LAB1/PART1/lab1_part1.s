...
_start:							# start now
		...
		addi	r2, r2, 1		# add immediate Q and 1, assign to R@
		ldw		r3, R(r0)		# load R into R3
		sub		r2, r2, r3		# subtract R3 from R2, assign to R2
		ldw		r3, S(r0)		# load S into R3
		mul		r2, r2, r3		# multiply R2 and R3, assign to R@
		ldw		r3, T(r0)		# load T into R3
		addi	r3, r3, 2		# add immediate T and 2, assign to R3
		div		r2, r2, r3		# divide R2 with R3, assign to R@
		stw		r2, P(r0)		# store in P
